...
from config.models_params.ml import lags, H, W
from config.data.split_config import *
from metrics.metrics import *
from visualization.save_plots import *

# depend on model: XGB, RF
from XGBoost.model import return_params, build_model, train_model, save_best_params
#from RF.model import return_params, build_model, train_model, save_best_params

# ============ paths =============
path_processed = '../../data/ML/latlon/processed/'
path_params = '../../data/ML/latlon/params/'

# depend on model: XGB, RF
path_results = '../../reports/results/XGBoost/latlon/'
